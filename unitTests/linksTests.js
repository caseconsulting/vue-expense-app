describe('testing links', () => {
    ...
    it('Test Link for basecamp in dropdown menu', browser => {
        browser
            ...
            .pause(5000)
            .windowHandles(function(result) {   //switches window
    ...
    it('Test Link for ADP dropdown menu', browser => {
        browser
            ...
            .windowHandles(function(result) {
                  browser.switchWindow(result.value[1]);
                  browser.assert.urlEquals('https://online.adp.com/signin/v1/?APPID=RDBX&productId=80e309c3-70c6-bae1-e053-3505430b5495&returnURL=https://my.adp.com/&callingAppId=RDBX&TARGET=-SM-https://my.adp.com/static/redbox/');
                  browser.closeWindow();
                  browser.pause(2500);
                  browser.switchWindow(result.value[0]);
                  browser.assert.urlEquals('http://localhost:8080/reimbursements');
    ...
    it('Test Link for Red Mine dropdown menu', browser => {
        browser
            ...
            .windowHandles(function(result) {
                  browser.switchWindow(result.value[1]);
                  browser.assert.urlEquals('https://redmine.consultwithcase.com/login?back_url=https%3A%2F%2Fredmine.consultwithcase.com%2F');
                  browser.closeWindow();
                  browser.pause(2500);
                  browser.switchWindow(result.value[0]);
                  browser.assert.urlEquals('http://localhost:8080/reimbursements');
