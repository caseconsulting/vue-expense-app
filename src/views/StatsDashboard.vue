<template>
  <div>
    <v-card :elevation="3" class="ma-15 mx-20">
      <v-card color="#bc3825">
      ...
      <v-container fluid>
        <v-tabs color="basil" center-active grow show-arrows class="ma-2">
...
>>>>>>> 2439-Add-a-chart-to-show-the-number-of-employees-on-each-prime-contract: Added the prime charts and made the customer org chart reactive
...
import CustomerOrgExpTab from '../components/charts/chartTabs/CustomerOrgExpTab.vue';
