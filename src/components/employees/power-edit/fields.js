...
// prettier-ignore
export let fields = [
  { title: 'Name', key: 'name', selected: true, infoType: TYPES.DEFAULT },
  ...
  { title: 'Birthday', key: 'birthday', selected: false, editType: TYPES.DATE_MMDDYYYY, infoType: TYPES.DATE_MMDDYYYY },
  { title: 'Job Role', key: 'jobRole', selected: true, editType: TYPES.CUSTOM, infoType: TYPES.DEFAULT },
  { title: 'Employee Role', key: 'employeeRole', selected: false, editType: TYPES.CUSTOM, infoType: TYPES.DEFAULT },
